...
function buildConfig(fileConfig) {
    return {
        ...
        systemPromptInjection: {
            enabled: fileConfig.systemPromptInjection?.enabled ?? DEFAULTS.systemPromptInjection.enabled,
            tokenBudget: fileConfig.systemPromptInjection?.tokenBudget ?? DEFAULTS.systemPromptInjection.tokenBudget,
            maxResults: fileConfig.systemPromptInjection?.maxResults ?? DEFAULTS.systemPromptInjection.maxResults,
            minSimilarity: fileConfig.systemPromptInjection?.minSimilarity ??
                DEFAULTS.systemPromptInjection.minSimilarity,
            usageHint: fileConfig.systemPromptInjection?.usageHint ?? DEFAULTS.systemPromptInjection.usageHint,
        },
        priming: {
